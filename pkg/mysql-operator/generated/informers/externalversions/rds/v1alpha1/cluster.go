...
import (
	...
	rdsv1alpha1 "github.com/huanwei/rds/pkg/mysql-operator/apis/rds/v1alpha1"
	versioned "github.com/huanwei/rds/pkg/mysql-operator/generated/clientset/versioned"
	internalinterfaces "github.com/huanwei/rds/pkg/mysql-operator/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/huanwei/rds/pkg/mysql-operator/generated/listers/rds/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RDSV1alpha1().Clusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RDSV1alpha1().Clusters(namespace).Watch(options)
			},
		},
		&rdsv1alpha1.Cluster{},
		resyncPeriod,
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rdsv1alpha1.Cluster{}, f.defaultInformer)
}
